...
public interface DataService {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataIntArray", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataInt")
    @ResponseWrapper(localName = "submitDataIntArrayResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataString", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataInt")
    @ResponseWrapper(localName = "submitDataStringResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataStringArray", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataInt")
    @ResponseWrapper(localName = "submitDataStringArrayResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "submitDataIntMatrix", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataInt")
    @ResponseWrapper(localName = "submitDataIntMatrixResponse", targetNamespace = "http://medianews.vn/", className = "vn.medianews.SubmitDataIntResponse")
